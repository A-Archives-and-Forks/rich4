...
add byte [eax + (_player_tool_amount + 4)], dl  ; add byte [eax + 0x499160], dl
...
sub eax, edx
lea edi, [eax + ebx]
cmp byte [edi + _player_tool_amount], 0  ; cmp byte [edi + 0x49915c], 0
...
add esp, 0x10
xor eax, eax
mov al, byte [edi + _player_tool_amount]  ; mov al, byte [edi + 0x49915c]
push eax
