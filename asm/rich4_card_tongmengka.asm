...
shl eax, 4
sub eax, ebx
mov edi, dword [eax + (_rich4_card_strings + 112)]  ; mov edi, dword [eax + 0x4812aa]
push edi
push 3
...
loc_004457e8:
imul eax, dword [_rich4_current_player], 0x68  ; imul eax, dword [0x49910c], 0x68
mov bl, byte [eax + (_rich4_all_players_state + 65)]  ; mov bl, byte [eax + 0x496ba9]
test bl, bl
...
imul ebx, edx, 0x68
xor cl, cl
mov byte [ebx + (_rich4_all_players_state + 65)], cl  ; mov byte [ebx + 0x496ba9], cl
xor edx, edx
mov dl, byte [eax + (_rich4_all_players_state + 65)]  ; mov dl, byte [eax + 0x496ba9]
dec edx
imul ebx, edx, 0x68
mov byte [ebx + (_rich4_all_players_state + 61)], cl  ; mov byte [ebx + 0x496ba5], cl
mov byte [eax + (_rich4_all_players_state + 65)], cl  ; mov byte [eax + 0x496ba9], cl
mov byte [eax + (_rich4_all_players_state + 61)], cl  ; mov byte [eax + 0x496ba5], cl
...
imul eax, edi, 0x68
mov byte [eax + (_rich4_all_players_state + 65)], dl  ; mov byte [eax + 0x496ba9], dl
mov byte [eax + (_rich4_all_players_state + 61)], 7  ; mov byte [eax + 0x496ba5], 7
mov al, byte [_rich4_current_player]  ; mov al, byte [0x49910c]
inc al
mov ebp, dword [esp]
imul ebx, ebp, 0x68
mov byte [ebx + (_rich4_all_players_state + 65)], al  ; mov byte [ebx + 0x496ba9], al
mov byte [ebx + (_rich4_all_players_state + 61)], 7  ; mov byte [ebx + 0x496ba5], 7
push edi
call _rich4_update_player_info_window  ; call 0x41d433
add esp, 4
mov bl, byte [ebx + (_rich4_all_players_state + 19)]  ; mov bl, byte [ebx + 0x496b7b]
and ebx, 0xff
mov eax, ebx
shl eax, 2
sub eax, ebx
...
shl eax, 4
sub eax, ebx
mov edx, dword [eax + (_rich4_card_strings + 352)]  ; mov edx, dword [eax + 0x48139a]
push edx
push 0
push ebp
call _rich4_player_say  ; call 0x44ef41
