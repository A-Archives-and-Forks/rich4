...
mov esi, dword [ecx + (_rich4_all_players_state + 28)]  ; mov esi, dword [ecx + 0x496b84]
add edx, esi
mov eax, edx
sar edx, 0x1f
sub eax, edx
...
loc_00442288:
imul eax, dword [_rich4_current_player], 0x68  ; imul eax, dword [0x49910c], 0x68
mov dword [eax + (_rich4_all_players_state + 28)], esi  ; mov dword [eax + 0x496b84], esi
imul ecx, ebp, 0x68
mov dword [ecx + (_rich4_all_players_state + 28)], esi  ; mov dword [ecx + 0x496b84], esi
cmp byte [eax + (_rich4_all_players_state + 21)], 1  ; cmp byte [eax + 0x496b7d], 1
je short loc_004422de  ; je 0x4422de
push 0x64
xor edx, edx
mov dx, word [ecx + (_rich4_all_players_state + 10)]  ; mov dx, word [ecx + 0x496b72]
push edx
xor edx, edx
mov dx, word [ecx + (_rich4_all_players_state + 8)]  ; mov dx, word [ecx + 0x496b70]
push edx
xor edx, edx
