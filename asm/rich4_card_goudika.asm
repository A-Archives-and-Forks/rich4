...
cmp edi, dword [edx + (_rich4_all_players_state + 28)]  ; cmp edi, dword [edx + 0x496b84]
...
shl eax, 4
sub eax, edx
mov ebp, dword [eax + (_rich4_card_strings + 8)]  ; mov ebp, dword [eax + 0x481242]
push ebp
push 3
push ecx
...
shl eax, 4
sub eax, edx
mov edx, dword [eax + (_rich4_card_strings + 248)]  ; mov edx, dword [eax + 0x481332]
push edx
push 1
push esi
call _rich4_player_say  ; call 0x44ef41
