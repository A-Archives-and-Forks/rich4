...
mov edx, dword [eax]
push 0
push _rich4_ddraw_font_sf_ptr  ; push 0x4762cc
push ref_0048a068  ; push 0x48a068
push eax
call dword [edx + 0x18]  ; ucall
mov eax, dword [_rich4_ddraw_font_sf_ptr]  ; mov eax, dword [0x4762cc]
mov edx, dword [eax]
push 0
push 1
push ref_0048a068  ; push 0x48a068
...
loc_0044f9c6:
mov ebx, dword [_rich4_ddraw_font_sf_ptr]  ; mov ebx, dword [0x4762cc]
test ebx, ebx
