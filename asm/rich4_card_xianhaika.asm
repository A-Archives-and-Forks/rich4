...
shl eax, 4
sub eax, ebx
mov edi, dword [eax + (_rich4_card_strings + 64)]  ; mov edi, dword [eax + 0x48127a]
push edi
push 3
...
imul edx, edx, 0x68
xor ecx, ecx
mov cx, word [edx + (_rich4_all_players_state + 10)]  ; mov cx, word [edx + 0x496b72]
push ecx
...
shl eax, 4
sub eax, edx
mov edx, dword [eax + (_rich4_card_strings + 304)]  ; mov edx, dword [eax + 0x48136a]
push edx
push 1
push ebx
call _rich4_player_say  ; call 0x44ef41
