...
global _rich4_call_god_of_death_entry
global _rich4_call_god_of_death_callback
global fcn_0043380a
...
mov dh, byte [ebx + (_rich4_all_players_state + 56)]  ; mov dh, byte [ebx + 0x496ba0]
inc dh
mov byte [ebx + (_rich4_all_players_state + 56)], dh  ; mov byte [ebx + 0x496ba0], dh
mov cl, dh
and cl, 0x7f
mov byte [ebx + (_rich4_all_players_state + 56)], cl  ; mov byte [ebx + 0x496ba0], cl
jmp near loc_004320aa  ; jmp 0x4320aa
...
add dword [ebx + (_rich4_all_players_state + 32)], eax  ; add dword [ebx + 0x496b88], eax
xor eax, eax
mov dword [ebx + (_rich4_all_players_state + 28)], eax  ; mov dword [ebx + 0x496b84], eax
push ecx
...
mov ax, word [eax + (_rich4_all_players_state + 12)]  ; mov ax, word [eax + 0x496b74]
and eax, 0xffff
mov ebx, eax
shl ebx, 2
add ebx, eax
...
_rich4_call_god_of_death_callback: 			; when player resigns to call god of death, this will be called
push ebx
push esi
push edi
push ebp
...
_rich4_call_god_of_death_entry:
push ebx
push esi
push edi
push ebp
...
add esp, 4
push ebp
push _rich4_call_god_of_death_callback  ; push 0x433088
call _Wait_0402_Message  ; call 0x4018e7
mov ebx, eax
add esp, 8
call fcn_00454bcc  ; call 0x454bcc
