...
xor ebx, ebx
mov bx, word [eax + (_all_players_state + 12)]  ; mov bx, word [eax + 0x496b74]
mov edx, ebx
shl edx, 2
add edx, ebx
mov ebx, dword [_rich4_map_node_ptr]  ; mov ebx, dword [0x498e80]
mov dx, word [ebx + edx*8]
mov word [eax + (_all_players_state + 8)], dx  ; mov word [eax + 0x496b70], dx
xor esi, esi
mov si, word [eax + (_all_players_state + 12)]  ; mov si, word [eax + 0x496b74]
mov edx, esi
shl edx, 2
add edx, esi
mov dx, word [ebx + edx*8 + 2]
mov word [eax + (_all_players_state + 10)], dx  ; mov word [eax + 0x496b72], dx
xor esi, esi
mov si, word [eax + (_all_players_state + 12)]  ; mov si, word [eax + 0x496b74]
mov edx, esi
shl edx, 2
...
xor dh, dh
mov byte [eax + (_all_players_state + 21)], dh  ; mov byte [eax + 0x496b7d], dh
...
mov cl, byte [eax + (_all_players_state + 63)]  ; mov cl, byte [eax + 0x496ba7]
test cl, cl
...
loc_0040ce48:
imul eax, dword [esp + 0x418], 0x68
mov ch, byte [eax + (_all_players_state + 64)]  ; mov ch, byte [eax + 0x496ba8]
test ch, ch
...
mov eax, ebx
shl eax, 4
cmp byte [eax + (_all_special_players_state + 10)], 0  ; cmp byte [eax + 0x498e32], 0
jne short loc_0040ce8a  ; jne 0x40ce8a
mov al, byte [eax + (_all_special_players_state + 8)]  ; mov al, byte [eax + 0x498e30]
and eax, 0xff
...
mov ebx, _all_players_state  ; mov ebx, 0x496b68
add ebx, esi
lea eax, [ebx + 0x1c]
mov edx, eax
sub edx, ebx
...
mov edx, esi
xor ebp, ebp
mov dword [eax + edx*4 + (_all_players_state + 76)], ebp  ; mov dword [eax + edx*4 + 0x496bb4], ebp
...
loc_0040d282:
mov dword [_current_player], ebp  ; mov dword [0x49910c], ebp
