...
xor ebx, ebx
mov bx, word [edx + (_rich4_all_players_state + 12)]  ; mov bx, word [edx + 0x496b74]
mov eax, ebx
shl eax, 2
add eax, ebx
...
shl eax, 4
sub eax, edx
mov ecx, dword [eax + (_rich4_card_strings + 24)]  ; mov ecx, dword [eax + 0x481252]
push ecx
push 3
...
shl eax, 4
sub eax, edx
mov edi, dword [eax + (_rich4_card_strings + 24)]  ; mov edi, dword [eax + 0x481252]
push edi
push 3
push esi
call _rich4_player_say  ; call 0x44ef41
