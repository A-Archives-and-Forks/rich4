...
extern fcn_0041d2c6
extern fcn_00423b3b
extern _rich4_update_commercial_owner
extern fcn_00436b0a
...
and eax, 0xffff
cmp eax, dword [edx + _rich4_player_stocks]  ; cmp eax, dword [edx + 0x4971a0]
...
shl eax, 2
sub eax, edx
cmp byte [ecx + eax + (_rich4_player_tool_amount - 1)], 0  ; cmp byte [ecx + eax + 0x49915b], 0
...
loc_00424a02:
cmp edi, dword [_rich4_num_players]  ; cmp edi, dword [0x499114]
...
mov dl, byte [eax + ref_004967e0]  ; mov dl, byte [eax + 0x4967e0]
imul eax, edi, 0x68
mov al, byte [eax + (_rich4_all_players_state + 20)]  ; mov al, byte [eax + 0x496b7c]
and eax, 0xff
shl eax, 2
add edx, eax
add edx, 8
...
mov edi, ecx
shl edi, 3
fild dword [edi + eax + _rich4_player_stocks]  ; fild dword [edi + eax + 0x4971a0]
fmul dword [edi + eax + (_rich4_player_stocks + 4)]  ; fmul dword [edi + eax + 0x4971a4]
call __round_toward_zero  ; call 0x457dbc
fistp dword [esp]
xor edx, edx
mov dx, word [ebx + ref_004967e8]  ; mov dx, word [ebx + 0x4967e8]
add dword [edi + eax + _rich4_player_stocks], edx  ; add dword [edi + eax + 0x4971a0], edx
mov eax, esi
shl eax, 2
sub eax, esi
shl eax, 5
...
sub edi, edx
mov dword [eax + _rich4_player_stocks], edi  ; mov dword [eax + 0x4971a0], edi
jne short loc_004256c2  ; jne 0x4256c2
mov dword [eax + (_rich4_player_stocks + 4)], edi  ; mov dword [eax + 0x4971a4], edi
...
shl eax, 2
sub eax, ecx
cmp byte [edi + eax + (_rich4_player_tool_amount - 1)], 9  ; cmp byte [edi + eax + 0x49915b], 9
...
add eax, edx
cmp dword [eax + _rich4_player_stocks], 0  ; cmp dword [eax + 0x4971a0], 0
...
mov ecx, dword [eax + _rich4_player_stocks]  ; mov ecx, dword [eax + 0x4971a0]
push ecx
lea eax, [esp + 4]
push eax
call _rich4_num_to_currency_string  ; call 0x452793
...
shl eax, 5
add eax, dword [esp + 0xd4]
fild dword [eax + _rich4_player_stocks]  ; fild dword [eax + 0x4971a0]
...
sub eax, edx
shl eax, 5
mov esi, dword [eax + ebx*8 + (_rich4_player_stocks - 8)]  ; mov esi, dword [eax + ebx*8 + 0x497198]
push esi
...
shl eax, 2
sub eax, edx
cmp byte [ebx + eax + _rich4_player_tool_amount], 0  ; cmp byte [ebx + eax + 0x49915c], 0
...
shl eax, 2
sub eax, edx
mov al, byte [ebx + eax + _rich4_player_tool_amount]  ; mov al, byte [ebx + eax + 0x49915c]
and eax, 0xff
push eax
...
sub eax, edx
add esi, eax
mov cl, byte [esi + _rich4_player_cards]  ; mov cl, byte [esi + 0x499120]
test cl, cl
...
mov dword [esp + 0xe4], eax
imul eax, dword [_rich4_price_index], 0x64  ; imul eax, dword [0x4990e8], 0x64
...
cmp ebx, 0x72
jge near loc_00427fc8  ; jge 0x427fc8
imul eax, dword [_rich4_current_player], 0x54  ; imul eax, dword [0x49910c], 0x54
...
cmp ebx, 0x72
jle near loc_00427e97  ; jle 0x427e97
mov edx, dword [_rich4_num_players]  ; mov edx, dword [0x499114]
mov eax, edx
shl eax, 3
add eax, edx
shl eax, 3
...
imul esi, esi, 0x68
xor eax, eax
mov al, byte [esi + (_rich4_all_players_state + 20)]  ; mov al, byte [esi + 0x496b7c]
shl eax, 2
add eax, edx
add eax, 8
mov dword [esp + 0x50], eax
...
push esi
mov ebp, dword [_rich4_ddraw_primary_sf_ptr]  ; mov ebp, dword [0x48a0dc]
push ebp
call dword [eax + 0x1c]  ; ucall
lea eax, [esp + 8]
push eax
...
mov cl, byte [eax + _rich4_player_cards]  ; mov cl, byte [eax + 0x499120]
cmp dl, cl
...
sub eax, edx
add eax, ebx
mov ch, byte [eax + _rich4_player_tool_amount]  ; mov ch, byte [eax + 0x49915c]
cmp ch, 3
...
loc_00428a92:
imul esi, dword [_rich4_current_player], 0x54  ; imul esi, dword [0x49910c], 0x54
mov eax, ebx
shl eax, 2
sub eax, ebx
shl eax, 2
