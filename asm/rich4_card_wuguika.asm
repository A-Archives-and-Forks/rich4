...
shl eax, 4
sub eax, ebx
mov ecx, dword [eax + (_rich4_card_strings + 116)]  ; mov ecx, dword [eax + 0x4812ae]
push ecx
push 3
push ebp
...
shl eax, 4
sub eax, edx
mov ecx, dword [eax + (_rich4_card_strings + 236)]  ; mov ecx, dword [eax + 0x481326]
push ecx
push 3
push esi
call _rich4_player_say  ; call 0x44ef41
add esp, 0xc
mov byte [ebx + (_rich4_all_players_state + 57)], 2  ; mov byte [ebx + 0x496ba1], 2
...
shl eax, 4
sub eax, edx
mov edx, dword [eax + (_rich4_card_strings + 356)]  ; mov edx, dword [eax + 0x48139e]
push edx
push 2
push esi
call _rich4_player_say  ; call 0x44ef41
...
loc_00445a3e:
shl esi, 4
mov byte [esi + (_rich4_all_special_players_state - (64 - 15))], 3  ; mov byte [esi + 0x498df7], 3
