...
shl eax, 4
sub eax, ebx
mov ecx, dword [eax + (_rich4_card_strings + 52)]  ; mov ecx, dword [eax + 0x48126e]
push ecx
push 3
push ebp
...
imul edx, esi, 0x68
xor ebx, ebx
mov bx, word [edx + (_rich4_all_players_state + 10)]  ; mov bx, word [edx + 0x496b72]
push ebx
...
xor edx, edx
mov dl, byte [ebx + (_rich4_all_players_state + 19)]  ; mov dl, byte [ebx + 0x496b7b]
mov eax, edx
shl eax, 2
sub eax, edx
shl eax, 3
...
shl eax, 4
sub eax, edx
mov ecx, dword [eax + (_rich4_card_strings + 172)]  ; mov ecx, dword [eax + 0x4812e6]
push ecx
push 3
push esi
call _rich4_player_say  ; call 0x44ef41
add esp, 0xc
mov byte [ebx + (_rich4_all_players_state + 56)], 0x80  ; mov byte [ebx + 0x496ba0], 0x80
...
shl eax, 4
sub eax, edx
mov edx, dword [eax + (_rich4_card_strings + 292)]  ; mov edx, dword [eax + 0x48135e]
push edx
push 2
push esi
call _rich4_player_say  ; call 0x44ef41
...
loc_004440d9:
shl esi, 4
mov byte [esi + (_rich4_all_special_players_state - (64 - 14))], 1  ; mov byte [esi + 0x498df6], 1
